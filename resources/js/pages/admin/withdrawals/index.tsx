                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between px-1">
                                    ...
                                    <span className="text-[10px] font-bold text-slate-400 uppercase">Max: {new Intl.NumberFormat().format(stats.availableBalanceFcfa)} CFA</span>
                                </div>
                                {withdrawalErrors.amount_fcfa && (
                                    <p className="text-red-500 text-xs">{withdrawalErrors.amount_fcfa}</p>
                                )}
                            </div>
